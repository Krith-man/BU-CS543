...
if __name__ == '__main__':
    ...
    # Max distortion
    run_experiment("vanilla", option="min", input=None, case=None, num_repetitions=10)
    run_experiment("achlioptas", option="max", input=None, case=0, num_repetitions=10)
    run_experiment("achlioptas", option="max", input=None, case=1, num_repetitions=10)
    run_experiment("cohen", option="max", input=None, case=0, num_repetitions=10)
    run_experiment("cohen", option="max", input=None, case=1, num_repetitions=10)
    # Min distortion
    run_experiment("vanilla", option="min", input=None, case=None, num_repetitions=10)
    run_experiment("achlioptas", option="min", input=None, case=0, num_repetitions=10)
    run_experiment("achlioptas", option="min", input=None, case=1, num_repetitions=10)
    run_experiment("cohen", option="min", input=None, case=0, num_repetitions=10)
    run_experiment("cohen", option="min", input=None, case=1, num_repetitions=10)
    # Mean distortion
    run_experiment("vanilla", option="mean", input=None, case=None, num_repetitions=10)
    run_experiment("achlioptas", option="mean", input=None, case=0, num_repetitions=10)
    run_experiment("achlioptas", option="mean", input=None, case=1, num_repetitions=10)
    run_experiment("cohen", option="mean", input=None, case=0, num_repetitions=10)
    run_experiment("cohen", option="mean", input=None, case=1, num_repetitions=10)
